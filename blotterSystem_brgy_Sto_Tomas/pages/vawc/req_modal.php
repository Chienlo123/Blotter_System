              ...
              <div class="modal-dialog modal-lg" >
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Manage VAWC</h4>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4" >
                                        <input name="txt_cname" class="form-control input-sm" type="text" placeholder="Complainant Fullbname"/>
                                    </div> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4" >
                                        <input name="txt_ccontact" class="form-control input-sm" type="number" placeholder="Complainant Contact:"/>
                                    </div> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4" >
                                        <input name="txt_pname" class="form-control input-sm" type="text" placeholder="Respondent Fullbname"/>
                                    </div> 
                                    ...
                                    <div class="col-sm-4">
                                        <select name="compgen" class="form-control input-sm">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4" >
                                        <input name="txt_padd" class="form-control input-sm" type="text" placeholder="Respondent Address:"/>
                                    </div> 
                                    ...
                                    <div class="col-sm-4" >
                                        <input name="txt_headchief" class="form-control input-sm" type="text" placeholder="HeadChief:"/>
                                    </div> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <textarea name="txt_complaint" class="form-control input-sm" type="text" placeholder="Accusation:"></textarea>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <select name="respgen" class="form-control input-sm">
                                            <option value="Male">Male</option>
                                            <option value="Female">Female</option>
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="submit" class="btn btn-primary btn-sm" name="btn_req" value="Add vawc"/>
