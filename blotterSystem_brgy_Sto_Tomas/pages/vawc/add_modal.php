              ...
              <div class="modal-dialog modal-lg" >
                <div class="modal-content">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4" >
                                        <input name="txt_cname" class="form-control input-sm" type="text" required="" placeholder="Complainant Fullbname"/>
                                    </div> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4" >
                                        <input name="txt_pname" class="form-control input-sm" required="" type="text" placeholder="Respondent Fullbname"/>
                                    </div> 
                                    ...
                                    <div class="col-sm-4">
                                        <select name="compgen"required=""  class="form-control input-sm">
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="submit" class="btn btn-primary btn-sm" name="btn_add" value="Add VAWC"/>
