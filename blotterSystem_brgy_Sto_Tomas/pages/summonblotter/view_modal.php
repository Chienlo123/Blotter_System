<!-- in this part it is the view data of summonlevel1 -->
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title">Manage Summon Level1</h4>
        </div>
        ...
        <div class="modal-footer">
		 ...
		 <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#resolvesummonlevel1'.$row['id'].'" style="margin-right:10px; padding:10px; "><i class="fa fa-user-plus" aria-hidden="true"></i> Resolve </button>  
	   
		 <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#unresolvesummonlevel2'.$row['id'].'" style="margin-right:200px; padding:10px;"><i class="fa fa-user-plus" aria-hidden="true"></i> Unresolve </button>  
