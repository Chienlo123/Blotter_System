...
<?php echo '<div id="unresolvesummonlevel2'.$row['id'].'" class="modal fade">
		   ...
		   <div class="form-group">
                           <div class="col-sm-2" style="width:110px;">
                            ...
                            <div class="col-sm-4" >
							   ...
							   <div class="col-sm-2" style="width:110px; margin-left:-1px;">
                                    ...
                                    <div class="col-sm-4">
                                          <input name="txt_edit_setdate"  required="" type="date" class="form-control" style=" text-align:center;">
                     ...
                     <div class="form-group">
						   ...
						   <div class="col-sm-2" style="width:110px;">
                                      ...
                                      <div class="col-sm-4">
                                        <select name="txt_edit_settlement" required="" class="form-control input-sm" style="background-color:gray; color:white; text-align:center;" readonly >
							  ...
							  <div class="col-sm-2" style="width:110px; margin-left:-1px;">
                                    ...
                                    <div class="col-sm-4">
                                         <input name="txt_edit_settime"  type="time"  required=""class="form-control" style=" text-align:center;">
						   ...
						   <div class="col-sm-4">
                                        <textarea name="txt_edit_resolutioncase1"  required="" class="form-control input-sm" type="text"" ></textarea>
                            </div>
