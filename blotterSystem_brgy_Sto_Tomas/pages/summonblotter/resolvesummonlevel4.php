...
<?php echo '<div id="resolvesummonlevel4'.$row['id'].'" class="modal fade">
                    ...
                    <div class="col-sm-12">
                     ...
                     <div class="form-group">
						 ...
						 <div class="col-sm-2" style="width:110px;">
                            ...
                            <div class="col-sm-4" >
                                <textarea name="txt_edit_resolutioncase2"  required="" class="form-control input-sm" type="text" ></textarea>
                            </div> 
