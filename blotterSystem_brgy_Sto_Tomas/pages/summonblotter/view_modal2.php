...
<?php echo '<div id="viewModal2'.$row['id'].'" class="modal fade">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title">Manage Summon Level3</h4>
        </div>
            ...
            <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4" >
                                <input name="txt_edit_resolutioncase2" class="form-control input-sm" type="text" value="'.$row['resolutioncase2'].'" " readonly style="background-color:gray; color:white; text-align:center;">
                            </div> 
        ...
        <div class="modal-footer">
	     ...
	     <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#resolvesummonlevel5'.$row['id'].'" style="margin-right:10px; padding:10px; "><i class="fa fa-user-plus" aria-hidden="true"></i> Resolve </button>  
                                   
         <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#resolvesummonlevel6'.$row['id'].'" style="margin-right:200px; padding:10px;"><i class="fa fa-user-plus" aria-hidden="true"></i> Unresolve </button>  
