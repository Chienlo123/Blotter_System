...
if(isset($_POST['btn_add'])){
    ...
    $su = mysqli_query($con,"SELECT * from tblblotterofficer where username = '".$txt_uname."' ");
    ...
    if($ct == 0){
        ...
        if($name != ""){
            if(($imagetype=="image/jpeg" || $imagetype=="image/png" || $imagetype=="image/bmp") && $size<=2048000){
                    ...
                    {
                    $txt_image = $image;
                    $query = mysqli_query($con,"INSERT INTO tblblotterofficer (
                                        lname,
                                        fname,
                                        mname,
                                        bdate,
...
$su = mysqli_query($con,"SELECT * from tblblotterofficer where username = '".$txt_edit_uname."' and id not in (".$txt_id.") ");
$ct = mysqli_num_rows($su);
...
if($ct == 0){
    ...
    if($name != ""){
            if(($imagetype=="image/jpeg" || $imagetype=="image/png" || $imagetype=="image/bmp") && $size<=2048000){
                ...
                $update_query = mysqli_query($con,"UPDATE tblblotterofficer set 
        ...
        $chk_image = mysqli_query($con,"SELECT * from tblblotterofficer where id = '".$_POST['hidden_id']."' ");
...
if(isset($_POST['btn_delete']))
{
    if(isset($_POST['chk_delete']))
    {
        ...
        {
            $delete_query = mysqli_query($con,"DELETE from tblblotterofficer where id = '$value' ") or die('Error: ' . mysqli_error($con));
