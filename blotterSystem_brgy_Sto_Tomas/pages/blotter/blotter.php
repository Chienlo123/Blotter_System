<!-- all records of blotter is here -->
<!DOCTYPE html>
<html>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    ...
                    <?php
                    if(($_SESSION['role'] == "Administrators") || isset($_SESSION['staff']))
                    {
                    ?>
                            ...
                            <div class="box">
                                ...
                                <div class="box-header">
                                    <div style="padding:10px;">
                                        ...
                                        <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addModal"><i class="fa fa-user-plus" aria-hidden="true"></i> File Blotter </button>  
                                        <?php 
                                    ...
                                    <table id="table" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align:center; justify:center;">Accusation</th>
                                        ...
                                        <tbody>
                                            ...
                                            if(!isset($_SESSION['staff']))
                                            {
                                                ...
                                                $squery = mysqli_query($con, "select * from tblblotter where status = 'Approved' ORDER BY id DESC ");
                                                while($row = mysqli_fetch_array($squery))
                                                {
                                                    ...
                                                    <tr>
                                                       ...
                                                       <a target="_blank" require="" href="blotter_form.php?admin='.$row['id'].'&gg='.$row['complainant'].'" class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Generate</a></td>
                                    ...
                                    <table id="table1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            if(!isset($_SESSION['staff']))
                                            {
                                                ...
                                                $squery = mysqli_query($con, "select * from tblblotter where status = 'Disapproved' ORDER BY id DESC ");
                                                while($row = mysqli_fetch_array($squery))
                                                {
                                                    echo '
                                                    <tr>
...
<!-- user or staff reqquest filling blotter and vawc pending -->
                    <div class="row">
                        <!-- left column -->
                            <div class="box">
                                <div class="box-header">  
                                    <div style="padding:10px;">
                                        <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#reqModal"><i class="fa fa-user-plus" aria-hidden="true"></i> Request File Blotter</button>  
                                    </div>
                                </div><!-- /.box-header -->
                                <div class="box-body table-responsive">

                                <ul class="nav nav-tabs" id="myTab">
                                      <li class="active"><a data-target="#new" data-toggle="tab">Pending File Blotter</a></li>
                                ...
                                <div class="tab-content">
                                    ...
                                    <table id="table" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $squery = mysqli_query($con, "SELECT * FROM tblblotter where status = 'New' ORDER BY id DESC") or die('Error: ' . mysqli_error($con));
...
<!-- user or staff approve-->
                                    ...
                                    <table id="table" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                              $squery = mysqli_query($con, "SELECT * FROM tblblotter where status = 'Approved' ORDER BY id DESC") or die('Error: ' . mysqli_error($con));
                                            if(mysqli_num_rows($squery))
                                            {
                                                while($row = mysqli_fetch_array($squery))
                                                {
...
<!-- user or staff disaprove-->
                                    ...
                                    <table id="table" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                              $squery = mysqli_query($con, "SELECT * FROM tblblotter where status = 'Disapproved' ORDER BY id DESC ") or die('Error: ' . mysqli_error($con));
                                            if(mysqli_num_rows($squery))
                                            {
                                                while($row = mysqli_fetch_array($squery))
                                                {
