    ...
    <body class="skin-black">
          ...
          <div class="col-md-4 col-md-offset-4">
            ...
            <div class="panel-heading" style="text-align:center;">
              ...
              <h3 class="panel-title">
                <strong>
                   Barangay Sto Tomas VAWC Officer
                </strong>
              </h3>
            </div>
	  ...
	  <?php
        ...
        { 
            ...
            $user = mysqli_query($con, "SELECT * from tblvawcofficer where username = '$username' and password = '$password' ");
            $numrow_user = mysqli_num_rows($user);

            if($numrow_user > 0)
            {
                while($row = mysqli_fetch_array($user)){
                  $_SESSION['role'] = "Administratorss";
                  $_SESSION['userid'] = $row['id'];
                  $_SESSION['username'] = $row['username'];
                }    
                header ('location: ../vawcdashboard/dashboard.php');
            }
            else
            {
