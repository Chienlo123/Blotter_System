    ...
    if($ct == 0){
        ...
        if($name != ""){
            if(($imagetype=="image/jpeg" || $imagetype=="image/png" || $imagetype=="image/bmp") && $size<=2048000){
                    ...
                    {
                    $txt_image = $image;
                    $query = mysqli_query($con,"INSERT INTO tblstaff (
                                        lname,
                                        fname,
                                        mname,
                                        bdate,
...
$su = mysqli_query($con,"SELECT * from tblstaff where username = '".$txt_edit_uname."' and id not in (".$txt_id.") ");
$ct = mysqli_num_rows($su);
...
if($ct == 0){
    ...
    if($name != ""){
            if(($imagetype=="image/jpeg" || $imagetype=="image/png" || $imagetype=="image/bmp") && $size<=2048000){
                ...
                $update_query = mysqli_query($con,"UPDATE tblstaff set 
