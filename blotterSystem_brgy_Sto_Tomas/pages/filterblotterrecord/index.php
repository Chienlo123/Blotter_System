...
<head>
    ...
    <title>Filter Brgy Record System</title>
</head>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 mt-5">
                <h1 class="text-center">Filter Brgy Record System</h1>
                <hr>
            </div>
        </div>
        <div class="row">
                ...
                $('#records').DataTable({
                    ...
                    "columns": [{
                        ...
                        },
                        {
                            "data": "brgycaseno",
                            "render": function(data, type, row, meta) {
                                return `${row.brgycaseno}`;
                            }
                        },
                        {
                            "data": "summonlevel",
                            "render": function(data, type, row, meta) {
                                return `${row.summonlevel}`;
                            }
                        },
                        {
                            "data": "settlement"
                        },
                        {
                            "data": "dateRecorded",
                            "render": function(data, type, row, meta) {
                                return moment(row.dateRecorded).format('DD-MM-YYYY');
                            }
                        }
                    ]
                });
