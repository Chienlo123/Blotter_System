...
(1, '2022', '2022-10-21', 'Josephine Madeja', 39, 'Blk 37 Lot 57 Brgy Sto Tomas Calauan Laguna', 94215421, 'Myna Gajisan', 'Female', 'Blk 37 lot 50 Brgy Sto Tomas Calauan Laguna', 'Cherry Villanueva', 'Ininireklamo ni Josephine Madeja ang kanyang kapitbahay na si Myna Gajisan sa kadahilanang sinisiraan ako nito sa aming mga kapit bahay na ako daw ay sobra sobra mag presyo sa aking mga paninda, kahit na ang presyo na tinitinda ko ay tama lamang hindi labis at hindi kulang.', 'Female', 'Civil', 'Brgy Sto Tomas Calauan Laguna', 'blotter@gmail.com', '14:55:42', 'Approved', 0);
...
(379, 'Administrators', '2022-10-20 14:46:25', 'Added Summon File Blotter Request by Cherry Villanueva'),
(380, 'Administrators', '2022-10-20 14:47:23', 'Added Summon File Blotter Request by Cherry Villanueva'),
(381, 'Administrators', '2022-10-20 14:48:08', 'Added file Blotter Request by ediwow'),
(382, 'Administrators', '2022-10-20 14:55:42', 'Added file Blotter Request by Cherry Villanueva'),
(383, 'Administrators', '2022-10-20 14:59:46', 'Edit and Update File Blotter Request by Josephine Madeja'),
(384, 'Administrators', '2022-10-20 15:00:05', 'Edit and Update File Blotter Request by Josephine Madeja'),
(385, 'Administrators', '2022-10-20 15:00:29', 'Edit and Update File Blotter Request by Josephine Madeja'),
(386, 'Administrators', '2022-10-20 15:06:58', 'Edit and Update File Blotter Request by Josephine Madeja'),
(387, 'Administrators', '2022-10-20 15:07:16', 'Edit and Update File Blotter Request by Josephine Madeja'),
(388, 'Administrators', '2022-10-20 15:08:35', 'Edit and Update File Blotter Request by Josephine Madeja'),
(389, 'Administrators', '2022-10-20 15:23:00', 'Added Summon File Blotter Request by Cherry Villanueva');
...
CREATE TABLE `tblsummon` (
  ...
  `paddress` text NOT NULL,
  `status` varchar(20) NOT NULL,
  `headchiefold` varchar(50) NOT NULL,
  `summonlevel` varchar(100) NOT NULL,
  `resolutioncase1` varchar(255) NOT NULL,
  `resolutioncase2` varchar(255) NOT NULL,
  `resolutioncase3` varchar(255) NOT NULL,
  `settlement` varchar(50) NOT NULL,
  `settime` varchar(20) NOT NULL,
  `residentid` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tblsummon` (`id`, `yearRecorded`, `dateRecorded`, `complainant`, `brgycaseno`, `caddress`, `setdate`, `personToComplain`, `headchief`, `complaint`, `recordedby`, `time`, `paddress`, `status`, `headchiefold`, `summonlevel`, `resolutioncase1`, `resolutioncase2`, `resolutioncase3`, `settlement`, `settime`, `residentid`) VALUES
(1, '2022', '2022-10-21', 'Josephine Madeja', 1, 'Blk 37 Lot 57 Brgy Sto Tomas Calauan Laguna', '2022-10-19', 'Myna Gajisan', 'Cherry Villanueva', 'Ininireklamo ni Josephine Madeja ang kanyang kapitbahay na si Myna Gajisan sa kadahilanang sinisiraan ako nito sa aming mga kapit bahay na ako daw ay sobra sobra mag presyo sa aking mga paninda, kahit na ang presyo na tinitinda ko ay tama lamang hindi labis at hindi kulang.', 'blotter@gmail.com', '15:23:00', 'Blk 37 lot 50 Brgy Sto Tomas Calauan Laguna', 'summonnew', 'Cherry Villanueva', '1', '', '', '', '', '', 0);
